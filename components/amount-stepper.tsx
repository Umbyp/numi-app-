...
interface Props {
  ...
  /** ตัวควบคุมหลักในหน้ากรอกปริมาณ (add-food) — ปุ่ม 44x44 สีตามบอร์ด แทนที่ปุ่มกลมเล็กที่ใช้แทรกในแถวการ์ดคำสั่ง */
  large?: boolean;
}

/** ปุ่มปกติ (ใช้ในแถวแน่น ๆ ของการ์ดคำสั่ง) เล็กแค่ 28px แต่ hitSlop ชดเชยให้เป้ากดจริงถึง 44 ตามเกณฑ์ */
export function AmountStepper({ value, step = 10, unit = 'g', min = 1, onChange, large }: Props) {
  const c = useTheme();
